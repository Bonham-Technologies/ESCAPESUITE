...
const packages = [
  ...
  },
  {
    ...
    dir: 'apps/craft',
    thresholds: { lines: 100, statements: 99, branches: 97, functions: 100 },
  },
  {
    name: '@escapesuite/artist',
    dir: 'apps/artist',
    thresholds: { lines: 99, statements: 98, branches: 93, functions: 98 },
  },
  {
    name: '@escapesuite/shared',
    dir: 'packages/shared',
    thresholds: { lines: 100, statements: 98, branches: 90, functions: 100 },
  },
  {
