...
- 2601ccd: A locked track is locked for everything
...
- dce5dc4: A clip cannot be dropped onto a locked track
...
- 7e1840c: Dragging several selected clips to another track moves all of them, or none
...
- affcb7d: Moving a clip to another track is one undo step
...
- 57500e7: **An audio waveform on a timeline clip is no longer cut off at the bottom.** The waveform was
