...
import type { EditorState, Clip, ClipTransform, TextOverlayData, ShapeOverlayData, AnimatableProperty, Keyframe } from './types';
...
type RemainingSlice = Omit<EditorState, keyof HistorySlice | keyof PlaybackSlice | keyof MarkerSlice | keyof UiSlice | keyof ProjectSlice | keyof TrackSlice | keyof ClipSlice>;
